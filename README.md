...
```
  ...
  # References
  mongoose C networking library - the luaJson json parser, utilizes the mongoose next_json to tokenize the json into tokens for lua.
 - api reference:  https://mongoose.ws/documentation/#api-reference
